...
public class MergeTransformation implements Transformation {

    Bitmap discBitmap;

    public MergeTransformation(Bitmap discBitmap) {
        this.discBitmap = discBitmap;
    }

    @Override
    public Bitmap transform(Bitmap source) {
        Bitmap result = mergeThumbnailBitmap(discBitmap, source);
        source.recycle();
        return result;
    }
     ...
     * @return
     */
    private Bitmap mergeThumbnailBitmap(Bitmap discBitmap, Bitmap albumBitmap) {
